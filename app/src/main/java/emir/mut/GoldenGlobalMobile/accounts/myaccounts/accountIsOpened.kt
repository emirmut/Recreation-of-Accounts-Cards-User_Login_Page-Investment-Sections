...
class accountIsOpened {
    companion object {
        @SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
        @Composable
        fun accountIsOpened(navController: NavController) {
            Scaffold(
                content = {
    ...
    @Composable
    fun accountIsOpenedPreview() {
        GoldenGlobalMobileTheme {
            accountIsOpened(navController = rememberNavController())
        }
    }
}