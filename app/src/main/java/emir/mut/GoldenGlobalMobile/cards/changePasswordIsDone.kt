...
class changePasswordIsDone {
    companion object {
        @SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
        @Composable
        fun changePasswordIsDone(navController: NavController) {
            Scaffold(
                content = {
                    Column(modifier = Modifier
                        ...
                        Text(
                            text = "Kartınızın şifresi başarıyla değiştirilmiştir.",
    ...
    @Composable
    fun changePasswordIsDonePreview() {
        GoldenGlobalMobileTheme {
            changePasswordIsDone(navController = rememberNavController())
        }
    }
}